...
""""
This is the same as the clusterSequences CLI program in this repo
"""
def clusterSequences(strains, cutoff, min_size):
    ##name of distance matrix
    distance_matrix = "distancematrix.npy"
    ##name of output file
    outfile = "mcp_results"
    ####
    ...
    statsfile = str(int(cutoff))+'th_percentile_min' + str(min_size)+'strains_stats.csv'
    stats = os.path.join(archive, statsfile)
